...
func (s *patches) FindPatches(ctx context.Context) (*operations.FindPatchesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out []operations.FindPatches200ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out); err != nil {
				return nil, err
			}

			res.FindPatches200ApplicationJSONObjects = out
...
func (s *patches) FindPatchesByID(ctx context.Context, request operations.FindPatchesByIDRequest) (*operations.FindPatchesByIDResponse, error) {
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.FindPatchesByID200ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out); err != nil {
				return nil, err
			}

			res.FindPatchesByID200ApplicationJSONObject = out
		case utils.MatchContentType(contentType, `application/xml`):
			res.Body = rawBody
		}
	}
...
func (s *patches) FindPatchesByName(ctx context.Context, request operations.FindPatchesByNameRequest) (*operations.FindPatchesByNameResponse, error) {
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.FindPatchesByName200ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out); err != nil {
				return nil, err
			}

			res.FindPatchesByName200ApplicationJSONObject = out
		case utils.MatchContentType(contentType, `application/xml`):
			res.Body = rawBody
		}
	}
