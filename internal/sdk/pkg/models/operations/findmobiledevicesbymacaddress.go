...
type FindMobileDevicesByMacAddressRequest struct {
	// Mac address to filter by
	Macaddress string `pathParam:"style=simple,explode=false,name=macaddress"`
}

type FindMobileDevicesByMacAddress200ApplicationXMLApplicationsApplication struct {
	ApplicationName    *string
	ApplicationVersion *string
	Identifier         *string
}

type FindMobileDevicesByMacAddress200ApplicationXMLApplications struct {
	Application *FindMobileDevicesByMacAddress200ApplicationXMLApplicationsApplication
	Size        *int64
}

type FindMobileDevicesByMacAddress200ApplicationXMLCertificatesCertificate struct {
	CommonName *string
	Identity   *bool
}

type FindMobileDevicesByMacAddress200ApplicationXMLCertificates struct {
	Certificate *FindMobileDevicesByMacAddress200ApplicationXMLCertificatesCertificate
	Size        *int64
}

type FindMobileDevicesByMacAddress200ApplicationXMLConfigurationProfilesConfigurationProfile struct {
	DisplayName *string
	Identifier  *string
	UUID        *string
	Version     *int64
...
type FindMobileDevicesByMacAddress200ApplicationXMLConfigurationProfiles struct {
	ConfigurationProfile *FindMobileDevicesByMacAddress200ApplicationXMLConfigurationProfilesConfigurationProfile
	Size                 *int64
}

type FindMobileDevicesByMacAddress200ApplicationXMLExtensionAttributes struct {
	ID    *int64
	Name  *string
	Type  *string
	Value *string
...
type FindMobileDevicesByMacAddress200ApplicationXMLGeneral struct {
	AssetTag                           *string
	Available                          *int64
	AvailableMb                        *int64
	BatteryLevel                       *int64
...
type FindMobileDevicesByMacAddress200ApplicationXMLLocation struct {
	Building     *string
	Department   *string
	EmailAddress *string
	Phone        *string
...
type FindMobileDevicesByMacAddress200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64
	Name *string
}

type FindMobileDevicesByMacAddress200ApplicationXMLMobileDeviceGroups struct {
	MobileDeviceGroup *FindMobileDevicesByMacAddress200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup
	Size              *int64
}

type FindMobileDevicesByMacAddress200ApplicationXMLNetwork struct {
...
type FindMobileDevicesByMacAddress200ApplicationXMLProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string
...
type FindMobileDevicesByMacAddress200ApplicationXMLProvisioningProfiles struct {
...
type FindMobileDevicesByMacAddress200ApplicationXMLPurchasing struct {
	ApplecareID          *string
	IsLeased             *bool
	IsPurchased          *bool
	LeaseExpires         *string
...
type FindMobileDevicesByMacAddress200ApplicationXMLSecurityObject struct {
...
// FindMobileDevicesByMacAddress200ApplicationXML - OK
type FindMobileDevicesByMacAddress200ApplicationXML struct {
...
type FindMobileDevicesByMacAddress200ApplicationJSONApplicationsApplication struct {
	ApplicationName    *string `json:"application_name,omitempty"`
	ApplicationVersion *string `json:"application_version,omitempty"`
	Identifier         *string `json:"identifier,omitempty"`
}

type FindMobileDevicesByMacAddress200ApplicationJSONApplications struct {
	Application *FindMobileDevicesByMacAddress200ApplicationJSONApplicationsApplication `json:"application,omitempty"`
	Size        *int64                                                                  `json:"size,omitempty"`
}

type FindMobileDevicesByMacAddress200ApplicationJSONCertificatesCertificate struct {
	CommonName *string `json:"common_name,omitempty"`
	Identity   *bool   `json:"identity,omitempty"`
}

type FindMobileDevicesByMacAddress200ApplicationJSONCertificates struct {
	Certificate *FindMobileDevicesByMacAddress200ApplicationJSONCertificatesCertificate `json:"certificate,omitempty"`
	Size        *int64                                                                  `json:"size,omitempty"`
}

type FindMobileDevicesByMacAddress200ApplicationJSONConfigurationProfilesConfigurationProfile struct {
...
type FindMobileDevicesByMacAddress200ApplicationJSONConfigurationProfiles struct {
	ConfigurationProfile *FindMobileDevicesByMacAddress200ApplicationJSONConfigurationProfilesConfigurationProfile `json:"configuration_profile,omitempty"`
	Size                 *int64                                                                                    `json:"size,omitempty"`
}

type FindMobileDevicesByMacAddress200ApplicationJSONExtensionAttributes struct {
...
type FindMobileDevicesByMacAddress200ApplicationJSONGeneral struct {
...
type FindMobileDevicesByMacAddress200ApplicationJSONLocation struct {
...
type FindMobileDevicesByMacAddress200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64  `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
}

type FindMobileDevicesByMacAddress200ApplicationJSONMobileDeviceGroups struct {
	MobileDeviceGroup *FindMobileDevicesByMacAddress200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup `json:"mobile_device_group,omitempty"`
	Size              *int64                                                                              `json:"size,omitempty"`
}

type FindMobileDevicesByMacAddress200ApplicationJSONNetwork struct {
...
type FindMobileDevicesByMacAddress200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string `json:"display_name,omitempty"`
...
type FindMobileDevicesByMacAddress200ApplicationJSONProvisioningProfiles struct {
	MobileDeviceProvisioningProfile *FindMobileDevicesByMacAddress200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile `json:"mobile_device_provisioning_profile,omitempty"`
	Size                            *int64                                                                                              `json:"size,omitempty"`
}

type FindMobileDevicesByMacAddress200ApplicationJSONPurchasing struct {
...
type FindMobileDevicesByMacAddress200ApplicationJSONSecurityObject struct {
...
// FindMobileDevicesByMacAddress200ApplicationJSON - OK
type FindMobileDevicesByMacAddress200ApplicationJSON struct {
	Applications          []FindMobileDevicesByMacAddress200ApplicationJSONApplications          `json:"applications,omitempty"`
	Certificates          []FindMobileDevicesByMacAddress200ApplicationJSONCertificates          `json:"certificates,omitempty"`
	ConfigurationProfiles []FindMobileDevicesByMacAddress200ApplicationJSONConfigurationProfiles `json:"configuration_profiles,omitempty"`
	ExtensionAttributes   []FindMobileDevicesByMacAddress200ApplicationJSONExtensionAttributes   `json:"extension_attributes,omitempty"`
	General               *FindMobileDevicesByMacAddress200ApplicationJSONGeneral                `json:"general,omitempty"`
	Location              *FindMobileDevicesByMacAddress200ApplicationJSONLocation               `json:"location,omitempty"`
	MobileDeviceGroups    []FindMobileDevicesByMacAddress200ApplicationJSONMobileDeviceGroups    `json:"mobile_device_groups,omitempty"`
	Network               *FindMobileDevicesByMacAddress200ApplicationJSONNetwork                `json:"network,omitempty"`
	ProvisioningProfiles  []FindMobileDevicesByMacAddress200ApplicationJSONProvisioningProfiles  `json:"provisioning_profiles,omitempty"`
	Purchasing            *FindMobileDevicesByMacAddress200ApplicationJSONPurchasing             `json:"purchasing,omitempty"`
	SecurityObject        *FindMobileDevicesByMacAddress200ApplicationJSONSecurityObject         `json:"security_object,omitempty"`
}

type FindMobileDevicesByMacAddressResponse struct {
	Body        []byte
	ContentType string
	StatusCode  int
