...
type MatchMobileDevices200ApplicationXMLApplicationsApplication struct {
	ApplicationName    *string
	ApplicationVersion *string
	Identifier         *string
}

type MatchMobileDevices200ApplicationXMLApplications struct {
	Application *MatchMobileDevices200ApplicationXMLApplicationsApplication
	Size        *int64
}

type MatchMobileDevices200ApplicationXMLCertificatesCertificate struct {
	CommonName *string
	Identity   *bool
}

type MatchMobileDevices200ApplicationXMLCertificates struct {
	Certificate *MatchMobileDevices200ApplicationXMLCertificatesCertificate
	Size        *int64
}

type MatchMobileDevices200ApplicationXMLConfigurationProfilesConfigurationProfile struct {
	DisplayName *string
	Identifier  *string
	UUID        *string
	Version     *int64
...
type MatchMobileDevices200ApplicationXMLConfigurationProfiles struct {
	ConfigurationProfile *MatchMobileDevices200ApplicationXMLConfigurationProfilesConfigurationProfile
	Size                 *int64
}

type MatchMobileDevices200ApplicationXMLExtensionAttributes struct {
	ID    *int64
	Name  *string
	Type  *string
	Value *string
...
type MatchMobileDevices200ApplicationXMLGeneral struct {
	AssetTag                           *string
	Available                          *int64
	AvailableMb                        *int64
	BatteryLevel                       *int64
...
type MatchMobileDevices200ApplicationXMLLocation struct {
	Building     *string
	Department   *string
	EmailAddress *string
	Phone        *string
...
type MatchMobileDevices200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64
	Name *string
}

type MatchMobileDevices200ApplicationXMLMobileDeviceGroups struct {
	MobileDeviceGroup *MatchMobileDevices200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup
	Size              *int64
}

type MatchMobileDevices200ApplicationXMLNetwork struct {
...
type MatchMobileDevices200ApplicationXMLProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string
...
type MatchMobileDevices200ApplicationXMLProvisioningProfiles struct {
	MobileDeviceProvisioningProfile *MatchMobileDevices200ApplicationXMLProvisioningProfilesMobileDeviceProvisioningProfile
	Size                            *int64
}

type MatchMobileDevices200ApplicationXMLPurchasing struct {
	ApplecareID          *string
	IsLeased             *bool
	IsPurchased          *bool
	LeaseExpires         *string
...
type MatchMobileDevices200ApplicationXMLSecurityObject struct {
...
// MatchMobileDevices200ApplicationXML - OK
type MatchMobileDevices200ApplicationXML struct {
...
type MatchMobileDevices200ApplicationJSONApplicationsApplication struct {
	ApplicationName    *string `json:"application_name,omitempty"`
	ApplicationVersion *string `json:"application_version,omitempty"`
	Identifier         *string `json:"identifier,omitempty"`
}

type MatchMobileDevices200ApplicationJSONApplications struct {
	Application *MatchMobileDevices200ApplicationJSONApplicationsApplication `json:"application,omitempty"`
	Size        *int64                                                       `json:"size,omitempty"`
}

type MatchMobileDevices200ApplicationJSONCertificatesCertificate struct {
	CommonName *string `json:"common_name,omitempty"`
	Identity   *bool   `json:"identity,omitempty"`
}

type MatchMobileDevices200ApplicationJSONCertificates struct {
	Certificate *MatchMobileDevices200ApplicationJSONCertificatesCertificate `json:"certificate,omitempty"`
	Size        *int64                                                       `json:"size,omitempty"`
}

type MatchMobileDevices200ApplicationJSONConfigurationProfilesConfigurationProfile struct {
...
type MatchMobileDevices200ApplicationJSONConfigurationProfiles struct {
	ConfigurationProfile *MatchMobileDevices200ApplicationJSONConfigurationProfilesConfigurationProfile `json:"configuration_profile,omitempty"`
	Size                 *int64                                                                         `json:"size,omitempty"`
}

type MatchMobileDevices200ApplicationJSONExtensionAttributes struct {
...
type MatchMobileDevices200ApplicationJSONGeneral struct {
...
type MatchMobileDevices200ApplicationJSONLocation struct {
...
type MatchMobileDevices200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64  `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
}

type MatchMobileDevices200ApplicationJSONMobileDeviceGroups struct {
	MobileDeviceGroup *MatchMobileDevices200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup `json:"mobile_device_group,omitempty"`
	Size              *int64                                                                   `json:"size,omitempty"`
}

type MatchMobileDevices200ApplicationJSONNetwork struct {
...
type MatchMobileDevices200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string `json:"display_name,omitempty"`
...
type MatchMobileDevices200ApplicationJSONProvisioningProfiles struct {
	MobileDeviceProvisioningProfile *MatchMobileDevices200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile `json:"mobile_device_provisioning_profile,omitempty"`
	Size                            *int64                                                                                   `json:"size,omitempty"`
}

type MatchMobileDevices200ApplicationJSONPurchasing struct {
...
type MatchMobileDevices200ApplicationJSONSecurityObject struct {
...
// MatchMobileDevices200ApplicationJSON - OK
type MatchMobileDevices200ApplicationJSON struct {
	Applications          []MatchMobileDevices200ApplicationJSONApplications          `json:"applications,omitempty"`
	Certificates          []MatchMobileDevices200ApplicationJSONCertificates          `json:"certificates,omitempty"`
	ConfigurationProfiles []MatchMobileDevices200ApplicationJSONConfigurationProfiles `json:"configuration_profiles,omitempty"`
	ExtensionAttributes   []MatchMobileDevices200ApplicationJSONExtensionAttributes   `json:"extension_attributes,omitempty"`
	General               *MatchMobileDevices200ApplicationJSONGeneral                `json:"general,omitempty"`
	Location              *MatchMobileDevices200ApplicationJSONLocation               `json:"location,omitempty"`
	MobileDeviceGroups    []MatchMobileDevices200ApplicationJSONMobileDeviceGroups    `json:"mobile_device_groups,omitempty"`
	Network               *MatchMobileDevices200ApplicationJSONNetwork                `json:"network,omitempty"`
	ProvisioningProfiles  []MatchMobileDevices200ApplicationJSONProvisioningProfiles  `json:"provisioning_profiles,omitempty"`
	Purchasing            *MatchMobileDevices200ApplicationJSONPurchasing             `json:"purchasing,omitempty"`
	SecurityObject        *MatchMobileDevices200ApplicationJSONSecurityObject         `json:"security_object,omitempty"`
}
