...
type FindMobileDevicesByUDID200ApplicationXMLApplicationsApplication struct {
	ApplicationName    *string
	ApplicationVersion *string
	Identifier         *string
}

type FindMobileDevicesByUDID200ApplicationXMLApplications struct {
	Application *FindMobileDevicesByUDID200ApplicationXMLApplicationsApplication
	Size        *int64
}

type FindMobileDevicesByUDID200ApplicationXMLCertificatesCertificate struct {
	CommonName *string
	Identity   *bool
}

type FindMobileDevicesByUDID200ApplicationXMLCertificates struct {
	Certificate *FindMobileDevicesByUDID200ApplicationXMLCertificatesCertificate
	Size        *int64
}

type FindMobileDevicesByUDID200ApplicationXMLConfigurationProfilesConfigurationProfile struct {
	DisplayName *string
	Identifier  *string
	UUID        *string
	Version     *int64
...
type FindMobileDevicesByUDID200ApplicationXMLConfigurationProfiles struct {
	ConfigurationProfile *FindMobileDevicesByUDID200ApplicationXMLConfigurationProfilesConfigurationProfile
	Size                 *int64
}

type FindMobileDevicesByUDID200ApplicationXMLExtensionAttributes struct {
	ID    *int64
	Name  *string
	Type  *string
	Value *string
...
type FindMobileDevicesByUDID200ApplicationXMLGeneral struct {
	AssetTag                           *string
	Available                          *int64
	AvailableMb                        *int64
	BatteryLevel                       *int64
...
type FindMobileDevicesByUDID200ApplicationXMLLocation struct {
	Building     *string
	Department   *string
	EmailAddress *string
	Phone        *string
...
type FindMobileDevicesByUDID200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64
	Name *string
}

type FindMobileDevicesByUDID200ApplicationXMLMobileDeviceGroups struct {
	MobileDeviceGroup *FindMobileDevicesByUDID200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup
	Size              *int64
}

type FindMobileDevicesByUDID200ApplicationXMLNetwork struct {
...
type FindMobileDevicesByUDID200ApplicationXMLProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string
...
type FindMobileDevicesByUDID200ApplicationXMLProvisioningProfiles struct {
...
type FindMobileDevicesByUDID200ApplicationXMLPurchasing struct {
	ApplecareID          *string
	IsLeased             *bool
	IsPurchased          *bool
	LeaseExpires         *string
...
type FindMobileDevicesByUDID200ApplicationXMLSecurityObject struct {
...
// FindMobileDevicesByUDID200ApplicationXML - OK
type FindMobileDevicesByUDID200ApplicationXML struct {
...
type FindMobileDevicesByUDID200ApplicationJSONApplicationsApplication struct {
	ApplicationName    *string `json:"application_name,omitempty"`
	ApplicationVersion *string `json:"application_version,omitempty"`
	Identifier         *string `json:"identifier,omitempty"`
}

type FindMobileDevicesByUDID200ApplicationJSONApplications struct {
	Application *FindMobileDevicesByUDID200ApplicationJSONApplicationsApplication `json:"application,omitempty"`
	Size        *int64                                                            `json:"size,omitempty"`
}

type FindMobileDevicesByUDID200ApplicationJSONCertificatesCertificate struct {
	CommonName *string `json:"common_name,omitempty"`
	Identity   *bool   `json:"identity,omitempty"`
}

type FindMobileDevicesByUDID200ApplicationJSONCertificates struct {
	Certificate *FindMobileDevicesByUDID200ApplicationJSONCertificatesCertificate `json:"certificate,omitempty"`
	Size        *int64                                                            `json:"size,omitempty"`
}

type FindMobileDevicesByUDID200ApplicationJSONConfigurationProfilesConfigurationProfile struct {
...
type FindMobileDevicesByUDID200ApplicationJSONConfigurationProfiles struct {
	ConfigurationProfile *FindMobileDevicesByUDID200ApplicationJSONConfigurationProfilesConfigurationProfile `json:"configuration_profile,omitempty"`
	Size                 *int64                                                                              `json:"size,omitempty"`
}

type FindMobileDevicesByUDID200ApplicationJSONExtensionAttributes struct {
...
type FindMobileDevicesByUDID200ApplicationJSONGeneral struct {
...
type FindMobileDevicesByUDID200ApplicationJSONLocation struct {
...
type FindMobileDevicesByUDID200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64  `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
}

type FindMobileDevicesByUDID200ApplicationJSONMobileDeviceGroups struct {
	MobileDeviceGroup *FindMobileDevicesByUDID200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup `json:"mobile_device_group,omitempty"`
	Size              *int64                                                                        `json:"size,omitempty"`
}

type FindMobileDevicesByUDID200ApplicationJSONNetwork struct {
...
type FindMobileDevicesByUDID200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string `json:"display_name,omitempty"`
...
type FindMobileDevicesByUDID200ApplicationJSONProvisioningProfiles struct {
	MobileDeviceProvisioningProfile *FindMobileDevicesByUDID200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile `json:"mobile_device_provisioning_profile,omitempty"`
	Size                            *int64                                                                                        `json:"size,omitempty"`
}

type FindMobileDevicesByUDID200ApplicationJSONPurchasing struct {
...
type FindMobileDevicesByUDID200ApplicationJSONSecurityObject struct {
...
// FindMobileDevicesByUDID200ApplicationJSON - OK
type FindMobileDevicesByUDID200ApplicationJSON struct {
	Applications          []FindMobileDevicesByUDID200ApplicationJSONApplications          `json:"applications,omitempty"`
	Certificates          []FindMobileDevicesByUDID200ApplicationJSONCertificates          `json:"certificates,omitempty"`
	ConfigurationProfiles []FindMobileDevicesByUDID200ApplicationJSONConfigurationProfiles `json:"configuration_profiles,omitempty"`
	ExtensionAttributes   []FindMobileDevicesByUDID200ApplicationJSONExtensionAttributes   `json:"extension_attributes,omitempty"`
	General               *FindMobileDevicesByUDID200ApplicationJSONGeneral                `json:"general,omitempty"`
	Location              *FindMobileDevicesByUDID200ApplicationJSONLocation               `json:"location,omitempty"`
	MobileDeviceGroups    []FindMobileDevicesByUDID200ApplicationJSONMobileDeviceGroups    `json:"mobile_device_groups,omitempty"`
	Network               *FindMobileDevicesByUDID200ApplicationJSONNetwork                `json:"network,omitempty"`
	ProvisioningProfiles  []FindMobileDevicesByUDID200ApplicationJSONProvisioningProfiles  `json:"provisioning_profiles,omitempty"`
	Purchasing            *FindMobileDevicesByUDID200ApplicationJSONPurchasing             `json:"purchasing,omitempty"`
	SecurityObject        *FindMobileDevicesByUDID200ApplicationJSONSecurityObject         `json:"security_object,omitempty"`
}
