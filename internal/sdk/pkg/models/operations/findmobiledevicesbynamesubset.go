...
type FindMobileDevicesByNameSubset200ApplicationXMLApplicationsApplication struct {
	ApplicationName    *string
	ApplicationVersion *string
	Identifier         *string
}

type FindMobileDevicesByNameSubset200ApplicationXMLApplications struct {
	Application *FindMobileDevicesByNameSubset200ApplicationXMLApplicationsApplication
	Size        *int64
}

type FindMobileDevicesByNameSubset200ApplicationXMLCertificatesCertificate struct {
	CommonName *string
	Identity   *bool
}

type FindMobileDevicesByNameSubset200ApplicationXMLCertificates struct {
	Certificate *FindMobileDevicesByNameSubset200ApplicationXMLCertificatesCertificate
	Size        *int64
}

type FindMobileDevicesByNameSubset200ApplicationXMLConfigurationProfilesConfigurationProfile struct {
	DisplayName *string
	Identifier  *string
	UUID        *string
	Version     *int64
...
type FindMobileDevicesByNameSubset200ApplicationXMLConfigurationProfiles struct {
	ConfigurationProfile *FindMobileDevicesByNameSubset200ApplicationXMLConfigurationProfilesConfigurationProfile
	Size                 *int64
}

type FindMobileDevicesByNameSubset200ApplicationXMLExtensionAttributes struct {
	ID    *int64
	Name  *string
	Type  *string
	Value *string
...
type FindMobileDevicesByNameSubset200ApplicationXMLGeneral struct {
	AssetTag                           *string
	Available                          *int64
	AvailableMb                        *int64
	BatteryLevel                       *int64
...
type FindMobileDevicesByNameSubset200ApplicationXMLLocation struct {
	Building     *string
	Department   *string
	EmailAddress *string
	Phone        *string
...
type FindMobileDevicesByNameSubset200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64
	Name *string
}

type FindMobileDevicesByNameSubset200ApplicationXMLMobileDeviceGroups struct {
	MobileDeviceGroup *FindMobileDevicesByNameSubset200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup
	Size              *int64
}

type FindMobileDevicesByNameSubset200ApplicationXMLNetwork struct {
...
type FindMobileDevicesByNameSubset200ApplicationXMLProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string
...
type FindMobileDevicesByNameSubset200ApplicationXMLProvisioningProfiles struct {
...
type FindMobileDevicesByNameSubset200ApplicationXMLPurchasing struct {
	ApplecareID          *string
	IsLeased             *bool
	IsPurchased          *bool
	LeaseExpires         *string
...
type FindMobileDevicesByNameSubset200ApplicationXMLSecurityObject struct {
...
// FindMobileDevicesByNameSubset200ApplicationXML - OK
type FindMobileDevicesByNameSubset200ApplicationXML struct {
...
type FindMobileDevicesByNameSubset200ApplicationJSONApplicationsApplication struct {
	ApplicationName    *string `json:"application_name,omitempty"`
	ApplicationVersion *string `json:"application_version,omitempty"`
	Identifier         *string `json:"identifier,omitempty"`
}

type FindMobileDevicesByNameSubset200ApplicationJSONApplications struct {
	Application *FindMobileDevicesByNameSubset200ApplicationJSONApplicationsApplication `json:"application,omitempty"`
	Size        *int64                                                                  `json:"size,omitempty"`
}

type FindMobileDevicesByNameSubset200ApplicationJSONCertificatesCertificate struct {
	CommonName *string `json:"common_name,omitempty"`
	Identity   *bool   `json:"identity,omitempty"`
}

type FindMobileDevicesByNameSubset200ApplicationJSONCertificates struct {
	Certificate *FindMobileDevicesByNameSubset200ApplicationJSONCertificatesCertificate `json:"certificate,omitempty"`
	Size        *int64                                                                  `json:"size,omitempty"`
}

type FindMobileDevicesByNameSubset200ApplicationJSONConfigurationProfilesConfigurationProfile struct {
...
type FindMobileDevicesByNameSubset200ApplicationJSONConfigurationProfiles struct {
	ConfigurationProfile *FindMobileDevicesByNameSubset200ApplicationJSONConfigurationProfilesConfigurationProfile `json:"configuration_profile,omitempty"`
	Size                 *int64                                                                                    `json:"size,omitempty"`
}

type FindMobileDevicesByNameSubset200ApplicationJSONExtensionAttributes struct {
...
type FindMobileDevicesByNameSubset200ApplicationJSONGeneral struct {
...
type FindMobileDevicesByNameSubset200ApplicationJSONLocation struct {
...
type FindMobileDevicesByNameSubset200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64  `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
}

type FindMobileDevicesByNameSubset200ApplicationJSONMobileDeviceGroups struct {
	MobileDeviceGroup *FindMobileDevicesByNameSubset200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup `json:"mobile_device_group,omitempty"`
	Size              *int64                                                                              `json:"size,omitempty"`
}

type FindMobileDevicesByNameSubset200ApplicationJSONNetwork struct {
...
type FindMobileDevicesByNameSubset200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string `json:"display_name,omitempty"`
...
type FindMobileDevicesByNameSubset200ApplicationJSONProvisioningProfiles struct {
	MobileDeviceProvisioningProfile *FindMobileDevicesByNameSubset200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile `json:"mobile_device_provisioning_profile,omitempty"`
	Size                            *int64                                                                                              `json:"size,omitempty"`
}

type FindMobileDevicesByNameSubset200ApplicationJSONPurchasing struct {
...
type FindMobileDevicesByNameSubset200ApplicationJSONSecurityObject struct {
...
// FindMobileDevicesByNameSubset200ApplicationJSON - OK
type FindMobileDevicesByNameSubset200ApplicationJSON struct {
	Applications          []FindMobileDevicesByNameSubset200ApplicationJSONApplications          `json:"applications,omitempty"`
	Certificates          []FindMobileDevicesByNameSubset200ApplicationJSONCertificates          `json:"certificates,omitempty"`
	ConfigurationProfiles []FindMobileDevicesByNameSubset200ApplicationJSONConfigurationProfiles `json:"configuration_profiles,omitempty"`
	ExtensionAttributes   []FindMobileDevicesByNameSubset200ApplicationJSONExtensionAttributes   `json:"extension_attributes,omitempty"`
	General               *FindMobileDevicesByNameSubset200ApplicationJSONGeneral                `json:"general,omitempty"`
	Location              *FindMobileDevicesByNameSubset200ApplicationJSONLocation               `json:"location,omitempty"`
	MobileDeviceGroups    []FindMobileDevicesByNameSubset200ApplicationJSONMobileDeviceGroups    `json:"mobile_device_groups,omitempty"`
	Network               *FindMobileDevicesByNameSubset200ApplicationJSONNetwork                `json:"network,omitempty"`
	ProvisioningProfiles  []FindMobileDevicesByNameSubset200ApplicationJSONProvisioningProfiles  `json:"provisioning_profiles,omitempty"`
	Purchasing            *FindMobileDevicesByNameSubset200ApplicationJSONPurchasing             `json:"purchasing,omitempty"`
	SecurityObject        *FindMobileDevicesByNameSubset200ApplicationJSONSecurityObject         `json:"security_object,omitempty"`
}
