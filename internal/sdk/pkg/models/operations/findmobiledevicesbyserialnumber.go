...
type FindMobileDevicesBySerialNumber200ApplicationXMLApplicationsApplication struct {
	ApplicationName    *string
	ApplicationVersion *string
	Identifier         *string
}

type FindMobileDevicesBySerialNumber200ApplicationXMLApplications struct {
	Application *FindMobileDevicesBySerialNumber200ApplicationXMLApplicationsApplication
	Size        *int64
}

type FindMobileDevicesBySerialNumber200ApplicationXMLCertificatesCertificate struct {
	CommonName *string
	Identity   *bool
}

type FindMobileDevicesBySerialNumber200ApplicationXMLCertificates struct {
	Certificate *FindMobileDevicesBySerialNumber200ApplicationXMLCertificatesCertificate
	Size        *int64
}

type FindMobileDevicesBySerialNumber200ApplicationXMLConfigurationProfilesConfigurationProfile struct {
	DisplayName *string
	Identifier  *string
	UUID        *string
	Version     *int64
...
type FindMobileDevicesBySerialNumber200ApplicationXMLConfigurationProfiles struct {
	ConfigurationProfile *FindMobileDevicesBySerialNumber200ApplicationXMLConfigurationProfilesConfigurationProfile
	Size                 *int64
}

type FindMobileDevicesBySerialNumber200ApplicationXMLExtensionAttributes struct {
	ID    *int64
	Name  *string
	Type  *string
	Value *string
...
type FindMobileDevicesBySerialNumber200ApplicationXMLGeneral struct {
	AssetTag                           *string
	Available                          *int64
	AvailableMb                        *int64
	BatteryLevel                       *int64
...
type FindMobileDevicesBySerialNumber200ApplicationXMLLocation struct {
	Building     *string
	Department   *string
	EmailAddress *string
	Phone        *string
...
type FindMobileDevicesBySerialNumber200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64
	Name *string
}

type FindMobileDevicesBySerialNumber200ApplicationXMLMobileDeviceGroups struct {
	MobileDeviceGroup *FindMobileDevicesBySerialNumber200ApplicationXMLMobileDeviceGroupsMobileDeviceGroup
	Size              *int64
}

type FindMobileDevicesBySerialNumber200ApplicationXMLNetwork struct {
...
type FindMobileDevicesBySerialNumber200ApplicationXMLProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string
...
type FindMobileDevicesBySerialNumber200ApplicationXMLProvisioningProfiles struct {
...
type FindMobileDevicesBySerialNumber200ApplicationXMLPurchasing struct {
	ApplecareID          *string
	IsLeased             *bool
	IsPurchased          *bool
	LeaseExpires         *string
...
type FindMobileDevicesBySerialNumber200ApplicationXMLSecurityObject struct {
...
// FindMobileDevicesBySerialNumber200ApplicationXML - OK
type FindMobileDevicesBySerialNumber200ApplicationXML struct {
...
type FindMobileDevicesBySerialNumber200ApplicationJSONApplicationsApplication struct {
	ApplicationName    *string `json:"application_name,omitempty"`
	ApplicationVersion *string `json:"application_version,omitempty"`
	Identifier         *string `json:"identifier,omitempty"`
}

type FindMobileDevicesBySerialNumber200ApplicationJSONApplications struct {
	Application *FindMobileDevicesBySerialNumber200ApplicationJSONApplicationsApplication `json:"application,omitempty"`
	Size        *int64                                                                    `json:"size,omitempty"`
}

type FindMobileDevicesBySerialNumber200ApplicationJSONCertificatesCertificate struct {
	CommonName *string `json:"common_name,omitempty"`
	Identity   *bool   `json:"identity,omitempty"`
}

type FindMobileDevicesBySerialNumber200ApplicationJSONCertificates struct {
	Certificate *FindMobileDevicesBySerialNumber200ApplicationJSONCertificatesCertificate `json:"certificate,omitempty"`
	Size        *int64                                                                    `json:"size,omitempty"`
}

type FindMobileDevicesBySerialNumber200ApplicationJSONConfigurationProfilesConfigurationProfile struct {
...
type FindMobileDevicesBySerialNumber200ApplicationJSONConfigurationProfiles struct {
	ConfigurationProfile *FindMobileDevicesBySerialNumber200ApplicationJSONConfigurationProfilesConfigurationProfile `json:"configuration_profile,omitempty"`
	Size                 *int64                                                                                      `json:"size,omitempty"`
}

type FindMobileDevicesBySerialNumber200ApplicationJSONExtensionAttributes struct {
...
type FindMobileDevicesBySerialNumber200ApplicationJSONGeneral struct {
...
type FindMobileDevicesBySerialNumber200ApplicationJSONLocation struct {
...
type FindMobileDevicesBySerialNumber200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup struct {
	ID   *int64  `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
}

type FindMobileDevicesBySerialNumber200ApplicationJSONMobileDeviceGroups struct {
	MobileDeviceGroup *FindMobileDevicesBySerialNumber200ApplicationJSONMobileDeviceGroupsMobileDeviceGroup `json:"mobile_device_group,omitempty"`
	Size              *int64                                                                                `json:"size,omitempty"`
}

type FindMobileDevicesBySerialNumber200ApplicationJSONNetwork struct {
...
type FindMobileDevicesBySerialNumber200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile struct {
	DisplayName         *string `json:"display_name,omitempty"`
...
type FindMobileDevicesBySerialNumber200ApplicationJSONProvisioningProfiles struct {
	MobileDeviceProvisioningProfile *FindMobileDevicesBySerialNumber200ApplicationJSONProvisioningProfilesMobileDeviceProvisioningProfile `json:"mobile_device_provisioning_profile,omitempty"`
	Size                            *int64                                                                                                `json:"size,omitempty"`
}

type FindMobileDevicesBySerialNumber200ApplicationJSONPurchasing struct {
...
type FindMobileDevicesBySerialNumber200ApplicationJSONSecurityObject struct {
...
// FindMobileDevicesBySerialNumber200ApplicationJSON - OK
type FindMobileDevicesBySerialNumber200ApplicationJSON struct {
	Applications          []FindMobileDevicesBySerialNumber200ApplicationJSONApplications          `json:"applications,omitempty"`
	Certificates          []FindMobileDevicesBySerialNumber200ApplicationJSONCertificates          `json:"certificates,omitempty"`
	ConfigurationProfiles []FindMobileDevicesBySerialNumber200ApplicationJSONConfigurationProfiles `json:"configuration_profiles,omitempty"`
	ExtensionAttributes   []FindMobileDevicesBySerialNumber200ApplicationJSONExtensionAttributes   `json:"extension_attributes,omitempty"`
	General               *FindMobileDevicesBySerialNumber200ApplicationJSONGeneral                `json:"general,omitempty"`
	Location              *FindMobileDevicesBySerialNumber200ApplicationJSONLocation               `json:"location,omitempty"`
	MobileDeviceGroups    []FindMobileDevicesBySerialNumber200ApplicationJSONMobileDeviceGroups    `json:"mobile_device_groups,omitempty"`
	Network               *FindMobileDevicesBySerialNumber200ApplicationJSONNetwork                `json:"network,omitempty"`
	ProvisioningProfiles  []FindMobileDevicesBySerialNumber200ApplicationJSONProvisioningProfiles  `json:"provisioning_profiles,omitempty"`
	Purchasing            *FindMobileDevicesBySerialNumber200ApplicationJSONPurchasing             `json:"purchasing,omitempty"`
	SecurityObject        *FindMobileDevicesBySerialNumber200ApplicationJSONSecurityObject         `json:"security_object,omitempty"`
}
